...
class AppApiHelper @Inject constructor(private val apiHeader: ApiHeader) : ApiHelper {
    ...
    override fun getTaxiListApt(): Observable<TaxiDisplayResponse> =
        Rx2AndroidNetworking.get("https://fake-poi-api.mytaxi.com/?p1Lat=53.694865&p1Lon=9.757589&p2Lat=53.394655&p2Lon=10.099891")
                .build()
                .getObjectObservable(TaxiDisplayResponse::class.java)
